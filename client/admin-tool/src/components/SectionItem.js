...
import Typography from '@mui/material/Typography';
  ...
  * @returns
  */
 export default function SectionItem({ content, onDeleteCallback, onSaveCallback }) {
        ...
        <div style={{ marginLeft: "60px" }}>
            ...
            <div className="section-actions">
                <Stack direction="row" spacing={1} alignItems="center">
                    ...
                    <ColoredSwitch disabled={isPageDisabled}  checked={data.isPublished} onChange={(event) => setData({...data, isPublished: event.target.checked}) }/>
                    <Typography>Published</Typography>
                </Stack>
                <div>
                    <Button disabled={isPageDisabled} text="Delete" style={{"marginRight": "10px", "backgroundColor": "#EA4444"}} onClickCallback={onDeleteCallback}/>
                    <Button disabled={isPageDisabled} text="Save" onClickCallback={validateData}/>
                </div>
            </div>

            <TextEditor isDisabled={isPageDisabled} initialHtmlLoadStr={content["content"]} editorUpdateCallback={(updatedHtml) => setData({...data, content: updatedHtml})} />
