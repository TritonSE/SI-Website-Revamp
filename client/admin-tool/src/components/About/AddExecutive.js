 ...
 */
 ...
 export default function AddExecutive({
     ...
     const validateData = () => {
         setData({...data, "startYear": committeeYear["startYear"], "endYear": committeeYear["endYear"], "rank": parseInt(data["rank"]), "openInSameTab": false});
         ...
         Object.keys(data).forEach((key) => {
             if ((data[key].length < 1 || data[key] == null) && key !== "bio" && key !== "openInSameTab") {
                 errors[key] = true;
                 hasErrors = true;
